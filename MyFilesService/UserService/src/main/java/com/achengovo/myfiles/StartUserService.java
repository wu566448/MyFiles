...
public class StartUserService {
        public static void main(String[] args) throws Exception {
            ...
            serviceInstances.put(UserService.class.getName(), new UserServiceImpl());
            ...
            instance.setPort(Integer.parseInt(properties.getProperty("service.port","8001")));
            instance.setServiceName(UserService.class.getName());
